...
const avMessageItems = [
  'Автоответчики',
  'Статистика по объявлениям и сообщениям',
  'Оповещения о сообщениях в Telegram',
  'Мультиаккаунты',
]
const avPriceItems = [
  'Актуальная информация',
  'Поиск по регионам и городам',
  'Поиск по категориям',
  'Высокая скорость работы',
]
const avWordStatItems = [
  'Актуальная информация',
  'Поиск по регионам и городам',
  'Поиск по категориям',
  'Высокая скорость работы',
